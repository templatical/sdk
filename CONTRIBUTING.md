...
| Packages | Tool | Why |
|----------|------|-----|
| `types`, `core`, `renderer`, `import-beefree`, `import-unlayer`, `import-html`, `import-mjml`, `import-topol`, `import-stripo` | **tsdown** (Rolldown + Oxc) | Pure-TS libraries. tsdown bundles JS **and** rolls up `.d.ts` in one ~8-line config. Migrated off tsup → dropped `rollup` / `rollup-plugin-dts` from the build path. |
...
- **MIT** for `types`, `renderer`, `quality`, `import-beefree`, `import-unlayer`, `import-html`, `import-mjml`, `import-topol`, `import-stripo`
