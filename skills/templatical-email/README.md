...
templatical-email/
  ...
  scripts/                 # invoked by the skill — ships and runs on the user's machine
    ...
    import.mjs             # import Unlayer/BeeFree/HTML/MJML/Topol/Stripo/Chamaileon → Templatical JSON (via @templatical/import-*)
...
You can also **import** an existing Unlayer / BeeFree / HTML / MJML / Topol /
Stripo / Chamaileon template as a starting point (via the
`@templatical/import-*` converters, install-on-demand) — see "Importing an
