...
templatical-email/
  ...
  scripts/                 # invoked by the skill — ships and runs on the user's machine
    ...
    import.mjs             # import Unlayer/BeeFree/HTML/MJML/Topol → Templatical JSON (via @templatical/import-*)
...
template as a starting point (via the `@templatical/import-*` converters,
