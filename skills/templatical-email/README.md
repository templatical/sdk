...
templatical-email/
  ...
  scripts/                 # invoked by the skill — ships and runs on the user's machine
    ...
    import.mjs             # import Unlayer/BeeFree/Stripo/Topol/Chamaileon/MJML/HTML → Templatical JSON (via @templatical/import-*)
...
Chamaileon / MJML / HTML template as a starting point (via the
