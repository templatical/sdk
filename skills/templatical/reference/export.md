...
```
npx -y @templatical/template-tools@0.39.0 render .templatical/<name>.json --format mjml -o .templatical/<name>.mjml
npx -y @templatical/template-tools@0.39.0 render .templatical/<name>.json --format html -o .templatical/<name>.html
```
