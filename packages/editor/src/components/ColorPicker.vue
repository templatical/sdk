    ...
    <Teleport :to="popoverRoot" :disabled="!popoverRoot">
      ...
      >
        <div
          ...
          class="tpl-color-popover tpl:absolute tpl:rounded-[var(--tpl-radius)] tpl:border tpl:border-[var(--tpl-border)] tpl:bg-[var(--tpl-bg)] tpl:p-3 tpl:shadow-[var(--tpl-shadow-lg)]"
          :style="{
