...
<template>
  ...
  >
    ...
    <div class="tpl:flex-1 tpl:overflow-y-auto tpl:p-4">
      ...
      <template v-else-if="blockType === 'countdown'">
        <!-- Target Date -->
        <div class="tpl:mb-3.5">
          ...
          <input
            type="datetime-local"
            :class="inputClass"
            :value="(block as CountdownBlock).targetDate"
            @input="
              updateField(
                'targetDate',
                ($event.target as HTMLInputElement).value,
        ...
        <div class="tpl:mb-3.5">
          ...
          <select
            :class="inputClass"
            :value="(block as CountdownBlock).timezone"
            @change="
              updateField(
                'timezone',
          ...
          <div class="tpl:grid tpl:grid-cols-2 tpl:gap-2">
            ...
            >
              <input
                type="checkbox"
                class="tpl:size-3.5 tpl:cursor-pointer tpl:accent-[var(--tpl-primary)]"
                :checked="(block as CountdownBlock).showDays"
                @change="
                  updateField(
                    'showDays',
                    ($event.target as HTMLInputElement).checked,
            ...
            >
              <input
                type="checkbox"
                class="tpl:size-3.5 tpl:cursor-pointer tpl:accent-[var(--tpl-primary)]"
                :checked="(block as CountdownBlock).showHours"
                @change="
                  updateField(
                    'showHours',
                    ($event.target as HTMLInputElement).checked,
            ...
            >
              <input
                type="checkbox"
                class="tpl:size-3.5 tpl:cursor-pointer tpl:accent-[var(--tpl-primary)]"
                :checked="(block as CountdownBlock).showMinutes"
                @change="
                  updateField(
                    'showMinutes',
                    ($event.target as HTMLInputElement).checked,
            ...
            >
              <input
                type="checkbox"
                class="tpl:size-3.5 tpl:cursor-pointer tpl:accent-[var(--tpl-primary)]"
                :checked="(block as CountdownBlock).showSeconds"
                @change="
                  updateField(
                    'showSeconds',
                    ($event.target as HTMLInputElement).checked,
        ...
        <div class="tpl:mb-3.5">
          ...
          <SlidingPillSelect
            ...
            :model-value="(block as CountdownBlock).separator"
        ...
        <div class="tpl:mb-3.5">
          ...
          <select
            :class="inputClass"
            :value="(block as CountdownBlock).fontFamily || ''"
            @change="
              updateField(
                'fontFamily',
                ($event.target as HTMLSelectElement).value || undefined,
          ...
          <div class="tpl:mb-3.5">
            ...
            <div class="tpl:flex tpl:items-stretch">
              <input
                type="number"
                :class="inputGroupInputClass"
                :value="(block as CountdownBlock).digitFontSize"
                min="12"
                max="72"
                @input="
                  updateField(
          ...
          <div class="tpl:mb-3.5">
            ...
            <div class="tpl:flex tpl:items-stretch">
              <input
                type="number"
                :class="inputGroupInputClass"
                :value="(block as CountdownBlock).labelFontSize"
                min="8"
                max="24"
                @input="
                  updateField(
        ...
        <div class="tpl:grid tpl:grid-cols-2 tpl:gap-3">
          <div class="tpl:mb-3.5">
            ...
            <ColorPicker
              :model-value="(block as CountdownBlock).digitColor"
          ...
          <div class="tpl:mb-3.5">
            ...
            <ColorPicker
              :model-value="(block as CountdownBlock).labelColor"
        ...
        <div class="tpl:mb-3.5">
          ...
          <ColorPicker
            :model-value="(block as CountdownBlock).backgroundColor"
            @update:model-value="updateField('backgroundColor', $event)"
          />
        </div>
        ...
        <div class="tpl:mb-3.5">
          ...
          <div class="tpl:grid tpl:grid-cols-2 tpl:gap-2">
            <input
              type="text"
              :class="inputClass"
              :value="(block as CountdownBlock).labelDays"
            ...
            <input
              type="text"
              :class="inputClass"
              :value="(block as CountdownBlock).labelHours"
            ...
            <input
              type="text"
              :class="inputClass"
              :value="(block as CountdownBlock).labelMinutes"
            ...
            <input
              type="text"
              :class="inputClass"
              :value="(block as CountdownBlock).labelSeconds"
        ...
        <div class="tpl:mb-3.5">
          ...
          <input
            type="text"
            :class="inputClass"
            :value="(block as CountdownBlock).expiredMessage"
        ...
        <div class="tpl:mb-3.5">
          ...
          <input
            type="url"
            :class="inputClass"
            :value="(block as CountdownBlock).expiredImageUrl"
            placeholder="https://..."
            @input="
              updateField(
                'expiredImageUrl',
        ...
        >
          <input
            type="checkbox"
            class="tpl:size-3.5 tpl:cursor-pointer tpl:accent-[var(--tpl-primary)]"
            :checked="(block as CountdownBlock).hideOnExpiry"
            @change="
              updateField(
                'hideOnExpiry',
                ($event.target as HTMLInputElement).checked,
