...
<template>
  <Teleport v-if="popoverRoot && !pickerIsOpen" :to="popoverRoot">
    <div
      ...
      class="tpl tpl-text-toolbar tpl:absolute tpl:flex tpl:gap-1 tpl:rounded-lg tpl:border tpl:border-[var(--tpl-border)] tpl:bg-[var(--tpl-bg)] tpl:px-3 tpl:py-2 tpl:shadow-[var(--tpl-shadow-lg)]"
      :style="{
        ...themeStyles,
