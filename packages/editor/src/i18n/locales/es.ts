...
const es: typeof en = {
  ...
  blockSettings: {
    ...
    border: "Borde",
    borderSide: "Lado",
    linkSides: "Mismo borde en todos los lados",
    unlinkSides: "Definir cada lado por separado",
    linkCorners: "Mismo radio en todas las esquinas",
    unlinkCorners: "Definir cada esquina por separado",
