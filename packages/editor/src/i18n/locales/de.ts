...
const de: typeof en = {
  ...
  blockSettings: {
    ...
    border: "Rahmen",
    borderSide: "Seite",
    linkSides: "Gleicher Rahmen auf allen Seiten",
    unlinkSides: "Jede Seite einzeln festlegen",
    linkCorners: "Gleicher Radius an allen Ecken",
    unlinkCorners: "Jede Ecke einzeln festlegen",
