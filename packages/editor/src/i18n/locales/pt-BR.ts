...
const ptBR: typeof en = {
  ...
  blockSettings: {
    ...
    border: "Borda",
    borderSide: "Lado",
    linkSides: "Mesma borda em todos os lados",
    unlinkSides: "Definir cada lado separadamente",
    linkCorners: "Mesmo raio em todos os cantos",
    unlinkCorners: "Definir cada canto separadamente",
  ...
  savedBlocks: {
    ...
    saving: "Salvando...",
    cancel: "Cancelar",
    empty: "Nenhum bloco salvo ainda",
