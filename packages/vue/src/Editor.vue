...
import { useEditor, useHistory, useBlockActions, useAutoSave, useConditionPreview } from '@templatical/core';
...
<template>
    ...
    >
        ...
        <template v-if="!isReady">
            <div class="tpl:flex tpl:h-full tpl:items-center tpl:justify-center" style="background-color: var(--tpl-bg)">
                <span class="tpl:text-sm" style="color: var(--tpl-text-muted)">Loading...</span>
            </div>
        </template>
        <template v-else>
        ...
        >
            ...
            <div class="tpl:flex tpl:items-center tpl:gap-2.5">
                <svg width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect x="2" y="4" width="18" height="22" rx="3" fill="#525252" mask="url(#tpl-logo-fl)"/>
                </svg>
                <span class="tpl:text-sm tpl:font-semibold" style="color: var(--tpl-text); letter-spacing: -0.01em">
                    {{ t('header.title') }}
                </span>
            </div>
            ...
            <div class="tpl:flex tpl:min-w-[200px] tpl:items-center tpl:justify-end tpl:gap-3">
            </div>
        </header>
        ...
        <RightSidebar
            ...
            @update-block="(updates) => editor.updateBlock(editor.state.selectedBlockId!, updates)"
            @delete-block="() => {
