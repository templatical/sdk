...
import type { UseCommentsReturn, UseEditorReturn } from '@templatical/core/cloud';
        ...
        >
            ...
            >
                ...
                <button
                    class="tpl-comment-filter tpl:rounded-md tpl:px-2.5 tpl:py-1 tpl:text-xs tpl:font-medium tpl:transition-colors tpl:duration-150"
                    :class="
                        filterMode === 'all' ? 'tpl-comment-filter--active' : ''
                    "
                    @click="setFilter('all')"
                >
                ...
                <button
                    ...
                    @click="
                        setFilter(
                            'block',
                            editor.state.selectedBlockId ?? undefined,
                        )
                    "
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                v-if="
                                    thread.block_id &&
                                    isBlockMissing(thread.block_id)
                                "
                            ...
                            <button
                                ...
                                "
                                @click="
                                    editor.selectBlock(thread.block_id ?? '')
                                "
                            >
                                Block
                            </button>
                            ...
                            >
                                <textarea
                                    ...
                                    rows="3"
                                    @keydown="
                                        handleEditKeydown($event, thread.id)
                                    "
                                />
                            ...
                            >
                                ...
                                >
                                    <template
                                        v-if="expandedThreads.has(thread.id)"
                                    >
                                        <ChevronUp
                                            :size="11"
                                            :stroke-width="2"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            class="tpl:mt-1.5 tpl:flex tpl:gap-1.5"
                                        >
                                            <button
                        ...
                        <Transition name="tpl-replies">
                            ...
                            >
                                <div class="tpl:flex tpl:items-end tpl:gap-2">
                                    ...
                                    />
                                    <div
                                        class="tpl:flex tpl:shrink-0 tpl:flex-col tpl:gap-1"
                                    >
                                        <button
