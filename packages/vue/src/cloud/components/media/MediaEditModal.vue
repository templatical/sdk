        ...
        >
            ...
            >
                ...
                >
                    ...
                    <!-- Scrollable content -->
                    <div
                        class="tpl:min-h-0 tpl:flex-1 tpl:overflow-y-auto tpl:px-5"
                    >
                                    ...
                                    <div class="tpl:flex-1">
                                        ...
                                        <div class="tpl:relative">
                                            <input
                                                ...
                                                "
                                                :placeholder="
                                                    cropCoordinates?.width?.toString() ||
                                                    ''
                                                "
                                    ...
                                    <div class="tpl:flex-1">
                                        ...
                                        <div class="tpl:relative">
                                            <input
                                                ...
                                                "
                                                :placeholder="
                                                    cropCoordinates?.height?.toString() ||
                                                    ''
                                                "
                    ...
                    >
                        ...
                        >
                            {{
                                isSaving
                                    ? t.mediaLibrary.saving
                                    : t.mediaLibrary.saveChanges
                            }}
                        </button>
                    </div>
                </div>
