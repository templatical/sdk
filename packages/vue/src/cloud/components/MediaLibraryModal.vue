...
import { useMediaLibrary } from '@templatical/core/cloud';
import type {
    MediaCategory,
    MediaItem,
...
function isConfirmable(): boolean {
    ...
    return isAcceptedMimeType(
        library.previewItem.value.mime_type,
        props.accept,
    );
}
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <!-- Content area -->
                        <div
                            class="tpl:flex tpl:min-w-0 tpl:flex-1 tpl:flex-col"
                        >
                            <!-- Breadcrumb + Upload -->
                            <div
                            ...
                            <div
                                class="tpl:min-h-0 tpl:flex-1 tpl:overflow-y-auto"
                            >
                                ...
                                >
                                    <MediaUploadZone
                                        :is-uploading="
                                            library.isUploading.value
                                        "
                                        :upload-progress="
                                            library.uploadProgress.value
                                        "
                                        @upload="handleUpload"
                                    />
                                    <button
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    class="tpl:text-xs"
                                    :class="
                                        hasUsedFiles ? 'tpl:mb-2' : 'tpl:mb-4'
                                    "
                                    style="color: var(--tpl-text-muted)"
                                >
