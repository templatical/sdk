...
import type { UseEditorReturn, UseConditionPreviewReturn } from '@templatical/core';
...
const blockRegistry = inject<UseBlockRegistryReturn>('blockRegistry', undefined as unknown as UseBlockRegistryReturn);
...
const canUseAi = computed(() => planConfig?.hasFeature('ai_generation') ?? false);
