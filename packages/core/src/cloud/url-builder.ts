...
export const API_ROUTES = {
  ...
  "versions.index": `${TEMPLATE}/versions`,
  "versions.store": `${TEMPLATE}/versions`,
  "versions.show": `${TEMPLATE}/versions/{version}`,
  "versions.restore": `${TEMPLATE}/versions/{version}/restore`,
