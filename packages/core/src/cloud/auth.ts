...
export type { AuthConfig, AuthRequestOptions, HeadlessAuthConfig, TestEmailConfig, UserConfig };
...
export class AuthManager {
    ...
    get projectId(): string {
        if (!this._projectId) {
            throw new Error(
                'Project ID not available. Call initialize() first.',
            );
        }
    ...
    get tenantId(): string {
        if (!this._tenantId) {
            throw new Error(
                'Tenant ID not available. Call initialize() first.',
            );
        }
    ...
    get tenantSlug(): string {
        if (!this._tenantSlug) {
            throw new Error(
                'Tenant slug not available. Call initialize() first.',
            );
        }
...
export function createHeadlessAuthManager(
