...
describe("public Agent Skill page tracks skill generation rules", () => {
  ...
  it("rules.md forbids countdown and custom", () => {
    expect(rules).toMatch(/Never emit `countdown` or `custom`/);
  });

  it("English page forbids countdown and custom and names the schema contract", () => {
  ...
  it("German page forbids countdown and custom and names the schema contract", () => {
