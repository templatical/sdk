...
The skill is a build-time tool: it authors templates and wires up integrations. Your **runtime** is [`@templatical/editor`](/getting-started/quick-start) (your users build emails, you get JSON out) plus [`@templatical/renderer`](/api/renderer-typescript) (JSON → MJML/HTML to send).
