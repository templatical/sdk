...
<template>
  <section class="hero relative overflow-hidden">
    ...
    <div class="hero__content relative z-10 mx-auto max-w-6xl px-6 pb-20">
      <div class="intro max-w-3xl">
        ...
        >
          AI, MCP, real-time collaboration, comments, a media library, template
          scoring, and a headless API — on top of Templatical's OSS Vue 3
          editor.
        </p>
  ...
  <section class="mx-auto max-w-6xl border-t border-border px-6 py-20">
    <div class="reveal mb-12 max-w-2xl">
      ...
      <p class="mt-3 text-text-muted">
        Six highlights below. {{ features.length - 6 }} more on the features
        page.
      </p>
    </div>
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <FeatureCard v-for="f in highlights" :key="f.slug" :feature="f" compact />
    </div>
    <div class="mt-8">
    ...
    <div class="reveal grid gap-12 lg:grid-cols-2 lg:items-center">
      <div>
        ...
        <p class="mt-4 text-base leading-relaxed text-text-muted">
          Same editor, same JSON, same MJML renderer. Export templates any time.
      ...
      <pre
        class="whitespace-pre-wrap break-words rounded-md border border-border bg-bg-subtle p-5 font-mono text-sm leading-relaxed text-text"
      ><code><span class="tok-comment">// Self-hosted OSS</span>
