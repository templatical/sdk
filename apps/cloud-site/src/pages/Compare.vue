...
const rows: Row[] = [
  ...
  {
    category: "Core editor",
    feature: "14 block types",
    oss: true,
    cloud: true,
  },
  {
    category: "Core editor",
    feature: "Merge tags & display conditions",
    oss: true,
    cloud: true,
  },
  {
    category: "Core editor",
    feature: "MJML → HTML renderer",
    oss: true,
    cloud: true,
  },
  {
    category: "Core editor",
    feature: "Theming & branding tokens",
    oss: true,
    cloud: true,
  },
  ...
  {
    category: "AI",
    feature: "Generate templates from a prompt",
    oss: false,
    cloud: true,
  },
  {
    category: "AI",
    feature: "Rewrite copy & tone-shift",
    oss: false,
    cloud: true,
  },
  {
    category: "AI",
    feature: "Design-to-template conversion",
    oss: false,
    cloud: true,
  },

  {
    ...
    feature: "Real-time co-editing with presence",
    oss: false,
    cloud: true,
  },
  {
    category: "Collaboration",
    feature: "Per-block locking",
    oss: false,
    cloud: true,
  },
  {
    category: "Collaboration",
    feature: "Inline comment threads",
    oss: false,
    cloud: true,
  },

  {
    ...
    feature: "Media library with folders & search",
    oss: false,
    cloud: true,
  },
  {
    category: "Assets & storage",
    feature: "Hosted template storage",
    oss: false,
    cloud: true,
  },
  {
    category: "Assets & storage",
    feature: "Saved reusable modules",
    oss: false,
    cloud: true,
  },
  ...
  {
    category: "Platform",
    feature: "MCP integration for AI agents",
    oss: false,
    cloud: true,
  },
    ...
    >
      <table class="w-full min-w-[640px] text-left text-sm">
        <caption class="sr-only">
          Feature comparison between open-source Templatical and Templatical
          Cloud, grouped by category.
        </caption>
        <thead
          class="bg-bg-subtle text-xs uppercase tracking-wider text-text-dim"
        >
          <tr>
            <th
              scope="col"
              class="sticky left-0 z-10 border-r border-border bg-bg-subtle px-6 py-4 font-semibold md:border-r-0"
            >
              Feature
            </th>
