...
<template>
  <footer class="mt-24 border-t border-border bg-bg-subtle">
    <div
    ...
    >
      <div>
        ...
        <p class="mt-3 text-sm text-text-muted">
          Premium hosted features for teams building email tooling at scale.
      ...
      <div>
        <h4
          class="text-xs font-semibold tracking-wider text-text-dim uppercase"
        >
          Product
        </h4>
    ...
    <div
      class="border-t border-border px-6 py-6 text-center text-xs text-text-dim"
    >
      © {{ new Date().getFullYear() }} Templatical. Coming soon.
    </div>
  </footer>
</template>
