...
const paths: Record<string, string> = {
    ...
    gauge: 'M12 13V2M19.4 15a8 8 0 1 1-14.8 0M14.5 10.5l2-2',
    package:
        'M16.5 9.4L7.5 4.21M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16zM3.27 6.96L12 12.01l8.73-5.05M12 22.08V12',
    send: 'M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z',
    history:
        'M3 12a9 9 0 1 0 3-6.7L3 8M3 3v5h5M12 7v5l3 3',
    plug: 'M9 2v6M15 2v6M12 17v5M4 12a8 8 0 0 1 16 0v1a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-1z',
    layers:
        'M12 2l10 6-10 6L2 8l10-6zM2 17l10 6 10-6M2 12l10 6 10-6',
...
const d = paths[props.name] ?? paths['arrow'];
</script>
