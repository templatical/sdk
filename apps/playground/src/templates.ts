...
function simulateFetch<T>(data: T, delayMs = 1500): Promise<T> {
...
export function registerDataSourcePicker(open: (request: DataSourcePickerRequest) => void): void {
    _pickerOpen = open;
}

/** Called by onFetch to show the picker modal. Returns the selected item or null. */
function openDataSourcePicker(request: DataSourcePickerRequest): Promise<DataSourcePickerItem | null> {
...
export function resolveDataSourcePicker(item: DataSourcePickerItem | null): void {
...
export const featuredArticleBlock: CustomBlockDefinition = {
    ...
    fields: [
        ...
        { type: 'textarea', key: 'excerpt', label: 'Excerpt', default: '', readOnly: true },
        { type: 'image', key: 'imageUrl', label: 'Cover Image', default: '', readOnly: true },
        { type: 'text', key: 'author', label: 'Author', default: '', readOnly: true },
        { type: 'text', key: 'readTime', label: 'Read Time', default: '', readOnly: true },
        { type: 'text', key: 'url', label: 'Article URL', default: '', readOnly: true },
  ...
  <div style="padding: 20px;">
    ...
    dataSource: {
        ...
        onFetch: async (ctx: { fieldValues: Record<string, unknown>; blockId: string }) => {
                ...
                items: [
                    {
                        ...
                        data: {
                            ...
                            excerpt: 'The problem is not the tokens or the components \u2014 it is adoption. After working with 50+ teams, here are the three patterns that separate the design systems people actually use from the ones that collect dust.',
                            imageUrl: 'https://placehold.co/560x280/fef2f2/dc2626?text=Design+Systems',
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            excerpt: 'Every startup says "move fast and break things" but few actually know when to slow down. Here is a practical framework for deciding when shipping speed matters more than polish.',
                            imageUrl: 'https://placehold.co/560x280/eff6ff/2563eb?text=Ship+Fast',
                            author: 'James Park',
                            readTime: '5 min read',
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            excerpt: 'WCAG AA compliance is not optional \u2014 it is a baseline. This guide walks through OKLch-based palette generation that guarantees contrast ratios while keeping your brand colors intact.',
                            imageUrl: 'https://placehold.co/560x280/ecfdf5/059669?text=Color+A11y',
                            author: 'Priya Sharma',
...
export const productShowcaseBlock: CustomBlockDefinition = {
    ...
    fields: [
        { type: 'text', key: 'heading', label: 'Section Heading', default: 'Trending Now' },
        { type: 'select', key: 'productCategory', label: 'Category', options: [
            { label: 'All', value: 'all' },
            { label: 'Electronics', value: 'electronics' },
            { label: 'Apparel', value: 'apparel' },
            { label: 'Accessories', value: 'accessories' },
        ], default: 'electronics' },
        { type: 'color', key: 'accentColor', label: 'Accent Color', default: '#dc2626' },
        {
            type: 'repeatable', key: 'products', label: 'Products',
            minItems: 1,
            maxItems: 4,
            fields: [
                ...
                { type: 'text', key: 'url', label: 'URL', default: 'https://example.com' },
            ],
            default: [],
        },
    ],
  ...
  <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
    ...
    dataSource: {
        ...
        onFetch: async (ctx: { fieldValues: Record<string, unknown>; blockId: string }) => {
            const category = (ctx.fieldValues.productCategory as string) || 'electronics';
                ...
                items: [
                    {
                        ...
                        data: {
                            products: [
                                { name: 'Wireless Pro Max', price: '$99', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Headphones', badge: '-50%', url: 'https://example.com/headphones' },
                                { name: 'Boom Speaker', price: '$59', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Speaker', badge: '-34%', url: 'https://example.com/speaker' },
                                { name: 'Chrono Smart', price: '$249', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Watch', badge: 'NEW', url: 'https://example.com/watch' },
                            ],
                        },
                    },
                    {
                        ...
                        data: {
                            products: [
                                { name: 'AirPods Ultra', price: '$179', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=AirPods', badge: 'NEW', url: 'https://example.com/airpods' },
                                { name: 'Smart Ring', price: '$299', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Ring', badge: 'NEW', url: 'https://example.com/ring' },
                                { name: 'Nano Charger', price: '$39', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Charger', badge: '', url: 'https://example.com/charger' },
                            ],
                        },
                    },
                    {
                        ...
                        data: {
                            products: [
                                { name: 'Classic Buds', price: '$29', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Buds', badge: '-60%', url: 'https://example.com/buds' },
                                { name: 'Travel Case', price: '$15', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Case', badge: '-40%', url: 'https://example.com/case' },
                                { name: 'USB Hub Pro', price: '$19', image: 'https://placehold.co/200x160/f3f4f6/6b7280?text=Hub', badge: '-55%', url: 'https://example.com/hub' },
                            ],
                        },
                    },
                ],
...
export const statsRowBlock: CustomBlockDefinition = {
    ...
    fields: [
        { type: 'text', key: 'stat1Label', label: 'Stat 1 Label', default: '', readOnly: true },
        { type: 'text', key: 'stat1Value', label: 'Stat 1 Value', default: '', readOnly: true },
        { type: 'text', key: 'stat2Label', label: 'Stat 2 Label', default: '', readOnly: true },
        { type: 'text', key: 'stat2Value', label: 'Stat 2 Value', default: '', readOnly: true },
        { type: 'text', key: 'stat3Label', label: 'Stat 3 Label', default: '', readOnly: true },
        { type: 'text', key: 'stat3Value', label: 'Stat 3 Value', default: '', readOnly: true },
        { type: 'color', key: 'accentColor', label: 'Accent Color', default: '#2563eb' },
    ],
  ...
  <div style="flex: 1; padding: 16px;">
    ...
    dataSource: {
        label: 'Change period',
        onFetch: async (_ctx: { fieldValues: Record<string, unknown>; blockId: string }) => {
...
export function createProductLaunchTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p><strong>Exclusive for VIP Partners:</strong> Get 6 months free on any v2.0 plan. Use code <strong>VIP2026</strong> at checkout.</p>',
                fontSize: 14, color: '#7c3aed', textAlign: 'center', fontWeight: 'normal',
            ...
            createTextBlock({
                content: '<p>You\u2019re currently on the <strong>Free</strong> plan. Upgrade to v2.0 Pro and get <strong>50% off your first 3 months</strong>.</p>',
                fontSize: 14, color: '#059669', textAlign: 'center', fontWeight: 'normal',
...
export function createWelcomeTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p>You\u2019re signed up on the <strong><span data-merge-tag="{{plan_name}}">Plan</span></strong> plan. We\u2019re thrilled to have you on board. Here are three things to do first:</p>',
                fontSize: 16,
                color: '#4b5563',
                textAlign: 'center',
                fontWeight: 'normal',
                ...
                children: [
                    [
                        createTextBlock({
                            ...
                            fontSize: 32, fontWeight: 'bold', color: '#2563eb', textAlign: 'center',
                            styles: pad(8, 8, 8, 8),
                        }),
                    ],
                    [
...
export function createOrderConfirmationTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p>Thanks <span data-merge-tag="{{first_name}}">First Name</span>, your order <strong>#<span data-merge-tag="{{order_id}}">1042</span></strong> is confirmed and being prepared.</p>',
                fontSize: 15,
                color: '#4b5563',
                textAlign: 'center',
                fontWeight: 'normal',
            ...
            createSectionBlock({
                ...
                children: [
                    [
                        createTextBlock({
                            content: '<p><strong>Shipping Address</strong></p><p><span data-merge-tag="{{first_name}}">Jane</span> <span data-merge-tag="{{last_name}}">Doe</span><br/>123 Main St, Apt 4B<br/>San Francisco, CA 94105</p>',
                    ...
                    [
                        createTextBlock({
                            content: '<p><strong>Order Total</strong></p><p>Subtotal: $132.00<br/>Shipping: $5.99<br/><strong>Total: <span data-merge-tag="{{order_total}}">$137.99</span></strong></p>',
            ...
            createTextBlock({
                content: '<p><span data-logic-merge-tag="{% if order_total > 100 %}" data-logic-type="open"></span>\u2705 You unlocked <strong>free shipping</strong> on your next order! Orders over $100 always ship free.<span data-logic-merge-tag="{% endif %}" data-logic-type="close"></span></p>',
                fontSize: 13, color: '#059669', textAlign: 'center', fontWeight: 'normal',
            ...
            createTextBlock({
                content: '<p>\u2b50 As a <strong>VIP member</strong>, enjoy an extra <strong>10% off</strong> your next order. Use code <strong>VIPLOVE</strong> at checkout.</p>',
                fontSize: 13, color: '#7c3aed', textAlign: 'center', fontWeight: 'normal',
...
export function createEventInvitationTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p>\ud83c\udf1f <strong>Early bird pricing:</strong> Register before March 31 and save 40%. Use code <strong>EARLYBIRD</strong>.</p>',
                fontSize: 14, color: '#b45309', textAlign: 'center', fontWeight: 'normal',
            ...
            createTextBlock({
                content: '<p>\ud83c\udfa4 <strong>Speaker info:</strong> Please arrive by 8:00 AM for sound check. Your backstage pass and speaker kit will be at the registration desk. <a href="https://example.com/speaker-guide">View speaker guide</a>.</p>',
                fontSize: 14, color: '#7c3aed', textAlign: 'center', fontWeight: 'normal',
                styles: { ...pad(12, 32, 12, 32), backgroundColor: '#f5f3ff' },
                displayCondition: {
                    label: 'Speakers',
...
export function createPasswordResetTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p>Hi <span data-merge-tag="{{first_name}}">First Name</span>,</p><p>We received a request to reset the password for your account (<span data-merge-tag="{{email}}">email@example.com</span>). Click the button below to choose a new password. This link will expire in 1 hour.</p>',
                fontSize: 15,
                color: '#4b5563',
                textAlign: 'center',
                fontWeight: 'normal',
            ...
            createTextBlock({
                content: '<p><strong>Security Tips</strong></p><p>\u2022 Never share your password with anyone<br/>\u2022 Use a unique password for each service<br/>\u2022 Enable two-factor authentication for extra protection<br/>\u2022 Check that the URL starts with https://vaultkey.com before entering credentials</p>',
                fontSize: 13,
                color: '#6b7280',
                textAlign: 'left',
                fontWeight: 'normal',
            ...
            createTextBlock({
                content: '<p>\ud83d\udd12 Protect your account: never share this link and enable two-factor authentication.</p>',
                fontSize: 13,
                color: '#6b7280',
                textAlign: 'center',
                fontWeight: 'normal',
...
export function createBlackFridayTemplate(): TemplateContent {
    return {
        ...
        blocks: [
            ...
            createTextBlock({
                content: '<p><strong>Enterprise exclusive:</strong> Bulk orders of 10+ units get an additional 15% off. <a href="https://example.com/enterprise" style="color: #fbbf24;">Contact sales</a></p>',
                fontSize: 13, color: '#d1d5db', textAlign: 'center', fontWeight: 'normal',
...
export type FeatureIcon = 'merge-tag' | 'display-condition' | 'data-source' | 'custom-block' | 'responsive';
