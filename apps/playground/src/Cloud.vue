    ...
    <div class="cloud flex flex-col h-screen font-sans bg-white text-gray-900">
        ...
        <template v-if="screen === 'start'">
            <div class="flex flex-col items-center justify-center min-h-screen px-6 py-12 gap-4">
                <div class="max-w-[800px] w-full text-center">
                    <div class="flex items-center gap-3 mb-2 justify-center">
                        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect x="2" y="4" width="18" height="22" rx="3" fill="#525252" mask="url(#cloud-logo)"/>
                        </svg>
                        <div>
                ...
                <div class="flex gap-4 max-w-[800px] w-full items-start">
                    <div class="flex-1 bg-white border border-gray-200 rounded-2xl p-8 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
                        <div class="flex items-center gap-1 mb-4">
                            <button
                                class="h-7 px-2.5 text-[12px] font-medium rounded-md border-none cursor-pointer transition-all duration-150"
                        ...
                        <div v-if="authMode === 'quick'">
                            ...
                            <div class="flex-1 mb-2.5">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Client ID</label>
                                <input
                                    v-model="clientId"
                                    type="text"
                                    class="w-full py-2.5 px-3.5 text-sm font-mono bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-400 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                                    :class="{ '!border-red-500': !isAuthValid && !clientId.trim() }"
                                    placeholder="your-client-id"
                                />
                            </div>
                            <div class="flex-1 mb-2.5">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Client Secret</label>
                                <input
                            ...
                            <div class="flex-1">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Tenant</label>
                                <input
                                    v-model="tenant"
                                    type="text"
                                    class="w-full py-2.5 px-3.5 text-sm font-mono bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-400 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                        ...
                        <div v-else>
                            ...
                            <div class="flex-1 mb-2.5">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Auth Endpoint</label>
                                <input
                                    v-model="authUrl"
                                    type="text"
                                    class="w-full py-2.5 px-3.5 text-sm font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-400 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                            ...
                            <div class="flex gap-3 mb-2.5">
                                <div class="flex-1">
                                    <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Method</label>
                                    <select v-model="authMethod" class="w-full py-2 px-3 pr-8 text-[13px] font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 cursor-pointer appearance-none bg-[url('data:image/svg+xml,%3Csvg_xmlns=%27http://www.w3.org/2000/svg%27_width=%2712%27_height=%2712%27_viewBox=%270_0_24_24%27_fill=%27none%27_stroke=%27%236b7280%27_stroke-width=%272%27_stroke-linecap=%27round%27_stroke-linejoin=%27round%27%3E%3Cpath_d=%27m6_9_6_6_6-6%27/%3E%3C/svg%3E')] bg-no-repeat bg-[position:right_10px_center] focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]">
                                        <option value="GET">GET</option>
                                        <option value="POST">POST</option>
                                    </select>
                                </div>
                                <div class="flex-1">
                                    <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Credentials</label>
                                    <select v-model="authCredentials" class="w-full py-2 px-3 pr-8 text-[13px] font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 cursor-pointer appearance-none bg-[url('data:image/svg+xml,%3Csvg_xmlns=%27http://www.w3.org/2000/svg%27_width=%2712%27_height=%2712%27_viewBox=%270_0_24_24%27_fill=%27none%27_stroke=%27%236b7280%27_stroke-width=%272%27_stroke-linecap=%27round%27_stroke-linejoin=%27round%27%3E%3Cpath_d=%27m6_9_6_6_6-6%27/%3E%3C/svg%3E')] bg-no-repeat bg-[position:right_10px_center] focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]">
                            ...
                            <div class="flex-1 mb-2.5">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Headers <span class="font-normal normal-case tracking-normal opacity-70">JSON, optional</span></label>
                                <textarea
                                    v-model="authHeaders"
                                    class="w-full py-2.5 px-3.5 text-sm font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 resize-y min-h-10 font-mono !text-xs placeholder:text-gray-400 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                                    rows="2"
                                    placeholder='{"Authorization": "Bearer ..."}'
                                ></textarea>
                            </div>
                            <div v-if="authMethod === 'POST'" class="flex-1 mb-2.5">
                                <label class="block text-[11px] font-semibold text-gray-500 mb-1.5 uppercase tracking-[0.5px]">Body <span class="font-normal normal-case tracking-normal opacity-70">JSON, optional</span></label>
                                <textarea
                                    v-model="authBody"
                                    class="w-full py-2.5 px-3.5 text-sm font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 resize-y min-h-10 font-mono !text-xs placeholder:text-gray-400 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                                    rows="2"
                        ...
                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                            ...
                            <button class="py-1.5 px-3.5 text-[13px] border border-gray-200 rounded-md bg-white text-gray-500 font-medium font-sans cursor-pointer transition-all duration-150 hover:text-gray-900 hover:bg-gray-50" @click="saveSettings(); authSaved = true; setTimeout(() => authSaved = false, 2000)">
                    ...
                    <div class="flex-1 bg-white border border-gray-200 rounded-2xl p-8 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input
                                    ...
                                    type="text"
                                    class="flex-1 py-3 px-4 text-sm font-sans bg-white border border-gray-200 rounded-lg text-gray-900 outline-none transition-all duration-150 placeholder:text-gray-500 focus:border-primary focus:shadow-[0_0_0_3px_oklch(70%_0.16_55_/_0.15)]"
                                    placeholder="Enter template UUID..."
                                    @keydown.enter="loadTemplate"
                                />
                                <button class="inline-flex items-center justify-center gap-2 py-3 px-5 text-sm font-medium font-sans border-none rounded-lg cursor-pointer transition-all duration-150 bg-primary text-white shadow-[0_1px_2px_rgba(0,0,0,0.08)] hover:not-disabled:bg-primary-hover hover:not-disabled:-translate-y-px hover:not-disabled:shadow-[0_4px_12px_oklch(70%_0.16_55_/_0.25)] disabled:opacity-50 disabled:cursor-not-allowed" :disabled="isLoading" @click="loadTemplate">
                                    Load
                                </button>
                            </div>
                        ...
                        <button class="w-full inline-flex items-center justify-center gap-2 py-3 px-5 text-sm font-medium font-sans rounded-lg cursor-pointer transition-all duration-150 bg-transparent text-gray-500 border border-gray-200 hover:not-disabled:bg-gray-50 hover:not-disabled:text-gray-900" @click="startFresh">
                ...
                <div class="max-w-[800px] w-full grid grid-cols-4 gap-x-6 gap-y-2 text-[13px] text-gray-500">
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/></svg>Version History</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v18m-6-6 6 6 6-6"/></svg>Auto Save</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>AI Writing</div>
                    ...
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>Media Library</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" x2="12" y1="2" y2="15"/></svg>Saved Modules</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/></svg>Test Email</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/></svg>MCP Integration</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22z"/></svg>Commenting</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/><polyline points="22 4 12 14.01 9 11.01"/></svg>Template Scoring</div>
                    <div class="flex items-center gap-2"><svg class="shrink-0 text-primary" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z"/><path d="m12 2 3.5 3.5L12 9 8.5 5.5 12 2Z"/><path d="M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z"/><path d="m12 15 3.5 3.5L12 22l-3.5-3.5L12 15Z"/></svg>White Label</div>
        ...
        <template v-else>
            <header class="flex items-center justify-between h-12 px-4 border-b border-gray-200 bg-white shrink-0">
                <div class="flex items-center gap-3">
                    <button class="inline-flex items-center gap-[5px] h-8 px-2.5 border border-gray-200 rounded-md bg-white text-gray-500 text-[13px] font-medium font-sans cursor-pointer transition-all duration-150 ease-in-out hover:text-gray-900 hover:bg-gray-50" @click="backToStart">
                ...
                <div class="flex items-center gap-2">
                    <button class="inline-flex items-center gap-[5px] h-8 px-2.5 border border-primary rounded-md bg-primary text-white text-[13px] font-medium font-sans cursor-pointer transition-all duration-150 ease-in-out hover:bg-primary-hover hover:border-primary-hover hover:text-white" @click="saveTemplate">
                        Save
                    </button>
                </div>
            </header>
