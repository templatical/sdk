export default {
  ...
  mergeTags: {
    ...
    descriptions: {
      ...
      ifVip: "Start a block shown only to VIP customers",
      elseBranch: "Alternate branch for the current condition",
      endIf: "Close the most recent conditional",
      forItem: "Loop over a list, such as order line items",
      endFor: "Close the most recent loop",
    },
  },
  demoImages: {
