...
export default {
  ...
  mergeTags: {
    ...
    elseBranch: "Sonst",
    endIf: "Ende wenn",
    forItem: "Für jeden Eintrag",
    endFor: "Ende Schleife",
    groups: {
      recipient: "Empfänger",
      account: "Konto",
      order: "Bestellung",
    ...
    descriptions: {
      ...
      ifVip: "Beginnt einen Block, der nur VIP-Kunden angezeigt wird",
      elseBranch: "Alternativer Zweig für die aktuelle Bedingung",
      endIf: "Schließt die letzte Bedingung",
      forItem: "Iteriert über eine Liste, z. B. Bestellpositionen",
      endFor: "Schließt die letzte Schleife",
    },
  },
  demoImages: {
